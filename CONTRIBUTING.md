...
1. Clone repository
   ...
   ```sh
   git clone https://github.com/flex-development/esast-util-from-code
   cd esast-util-from-code
   ```
...
```sh
https://github.com/flex-development/esast-util-from-code/compare/main...$branch
```
...
[discussion-qa]: https://github.com/flex-development/esast-util-from-code/discussions/new?category=q-a
